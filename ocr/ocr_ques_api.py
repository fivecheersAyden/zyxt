...
def upload_file():
    ...
    ocr_to_ques_prompt = """
你好，我会给你一段英文题目的OCR文本，请帮助我判断题型，并将OCR文本结果分割成对应的json，
如果是阅读题，输出格式如下：
{
    "category": "zuowen",
    "ques_body": "题干内容xxx"
...
"""
    ...
    usr_input = ocr_to_ques_prompt + final_text + "\n请注意，只输出解析后的json结果，并用```json ```包裹，不要输出其他内容"
    final_input = {
        "model": "generalv3.5",
    ...
    for line in response.iter_lines(decode_unicode="utf-8"):
        ...
        content = lineJson["choices"][0]["message"]["content"]

        return content, 200

if __name__ == "__main__":
    app.run(host="www.fivecheers.com", port=1039)
